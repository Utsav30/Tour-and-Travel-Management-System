...
if($_GET['book'])
{
		...
		session_start();
								...
								$pdf->Cell(130 ,30,'',0,1);//logo
								$pdf->SetFont('Arial','B',14);
								

								//Cell(width , height , text , border , end line , [align] )

								$pdf->Cell(130 ,5,'TOUR TRAVEL PVT. LTD.',0,0);
								$pdf->Cell(59 ,5,'INVOICE',0,1);//end of line

								//set font to arial, regular, 12pt
								$pdf->SetFont('Arial','',12);

								$pdf->Cell(130 ,5,'741,BH - 3',0,0);
								$pdf->Cell(25 ,5,'Date :',0,0);
								$pdf->Cell(34 ,5,date("d/m/Y"),0,1);//end of line

								$pdf->Cell(130 ,5,'IIIT-A, JHALWA',0,0);
								$pdf->Cell(25 ,5,'Invoice No. :',0,0);
								$pdf->Cell(34 ,5,$id,0,1);//end of line

								$pdf->Cell(130 ,5,'PIN - 211012',0,0);
