...
function myaccountstatus()
{
	...
	else 
	{
		...
		if($url=='user')
		{
			echo "<a href='user_account.php?user=$url' class='p-bar-item p-button p-hide-small p-hide-medium p-hover-white p-right  p-teal'>My Account</a>";
		}
		else
		{
			echo "<a href='admin_account.php?user=$url' class='p-bar-item p-button p-hide-small p-hide-medium p-hover-white p-right  p-teal'>My Account</a>";
		}
	}
