...
<div id="id01" >
  ...
  <form class="modal-content" method="post" action="" enctype="multipart/form-data">
	...
	-->
	<h2 class="userlogin">Customer Profile</h2>
    <div class="container">
	
	<table width=100%>
		<tr>
		  <td><label for="uname" ><b>Username:</b></label></td>
		  <?php $uname=$_GET['edit_customer']?>
		...
		<tr>		
		  ...
		  <td><input type="date" min="1947-01-01" max="2000-01-01" value="<?php dob($uname);?>" name="dob" required></td>
		</tr>
		<tr>
		   <td><label for="gender" ><b>Gender:</b></label></td>
		  <td><select name="gender" required>
			  <option selected="default"><?php gender($uname);?></option>
		...
		<tr>
		  ...
		  <td><input type="text" value="<?php address($uname);?>" name="address" required></td>
		</tr>
		<!--<tr>
